...
const ParentProfile = () => {
  return (
    <SafeAreaView  >
      ...
      <View style={styles.cont2}>
        ...
        <View style={{alignItems:'center'}}>
          <View style={styles.ele2}>
            <Text style={styles.txt3}>22</Text>
          </View>
          <Text style={styles.txt4}>يوم</Text>
        </View>
        <View style={{alignItems:'center'}}>
          <View style={styles.ele2}>
            <Text style={styles.txt3}>03</Text>
          </View>
      ...
      <View style={styles.cont3}>
        ...
        <ImageBackground 
           source={require('../../../assets2/images/backg.png')}
             style={styles.background}
              imageStyle={{width:343, height:61}}
             resizeMode='cover'
         >
            <View style={styles.overlay}>
               <Image source={require('../../../assets2/images/download.png')} />
      ...
      <Link screen={'code'}  style={[styles.link]}>اعادة تعيين كلمة السر</Link>
      </View>
    </SafeAreaView>
  )
}
